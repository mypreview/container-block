...
export default compose(
	...
	class Edit extends Component {
		...
		render() {
			...
			// Scroll-to
			const { show: scrlShow, customColor: scrlColor } = scroll;
			// Spacing
			const {
				desktop: hrzDesktop,
				laptop: hrzLaptop,
				...
				<Fragment>
					...
					<div
						className={ classnames( className, {
							...
							[ `wp-block-mypreview-container--dim-${ parseInt(
								dim
							) }` ]: dim,
						...
						style={ {
							...
							backgroundPosition:
								imgFocalPoint && 'custom' === imgPosition
									? `${ imgFocalPoint.x *
											100 }% ${ imgFocalPoint.y * 100 }%`
									: undefined,
							WebkitAnimation:
								imgID &&
								imgEffect &&
								imgEffect.includes( 'animate' )
