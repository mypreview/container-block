	...
	class Inspector extends Component {
		...
		reloadAOS() {
			const classname = 'aos-animate',
				el = $(
					`#block-${ this.props.clientId } .wp-block-mypreview-container`
				);
		...
		render() {
			...
			const imgPositionControls = [
				{
					label: _x( 'None', 'image position', 'container-block' ),
					value: '',
				},
				{
					label: _x(
			...
			if (
				...
				imgPositionControls.push( {
					label: _x( 'Custom', 'image position', 'container-block' ),
					value: 'custom',
				} );
			} // End If Statement
			// Image
				...
				<Fragment>
					<InspectorControls>
						<PanelBody initialOpen={ true }>
							<RangeControl
								...
								help={ _x(
									'Maximum width of the inner wrapper.',
									'panel title',
									'container-block'
								) }
								allowReset={ true }
						...
						>
							<ToggleControl
								...
								help={ _x(
									'Stretches the container to fit the whole height of the browser window.',
									'control help',
									'container-block'
								) }
								checked={ !! isFH }
								onChange={ () =>
									setAttributes( { isFH: ! isFH } )
								}
							/>
							<ToggleControl
								label={ _x(
								...
								help={ _x(
									'Displays a delicate scrolling mouse wheel animation that will offer direction to the user after the initial land on a website.',
									'control help',
									'container-block'
								) }
								checked={ !! scrlShow }
							...
							{ scrlShow && (
								<Fragment>
									<TextControl
										...
										help={ _x(
											'Smoothly scroll the window to a specific element or tag ID within the page.',
											'control help',
											'container-block'
										) }
										value={ scrlTarget }
									...
									/>
									<p className="components-base-control__field components-base-control__flex">
						...
						>
							<BaseControl
								...
								help={ _x(
									'Controls above are used to generate space around the container block’s content, inside of any defined borders.',
									'control help',
									'container-block'
								) }
							>
							...
							<BaseControl
								...
								help={ _x(
									'Controls above are used to create space around the container block, outside of any defined borders.',
									'control help',
									'container-block'
								) }
							>
						...
						>
							<SelectControl
								...
								help={ _x(
									'Shadow utlities to add a box shadow to the element.',
									'control help',
									'container-block'
								) }
								value={ shadow }
						...
						>
							<SelectControl
								...
								help={ _x(
									'Multiple shapes to use as separators for sections or as the background graphic.',
									'control help',
									'container-block'
								) }
								value={ shapeType }
						...
						>
							<SelectControl
								...
								help={ _x(
									'This module allows you to animate elements as you scroll down, and up.',
									'control help',
									'container-block'
								) }
								value={ aosType }
							...
							{ aosType && (
								<Fragment>
									...
									<RangeControl
										...
										help={ _x(
											'Change offset to trigger animations sooner or later in pixels.',
											'control help',
											'container-block'
										) }
										value={ aosOffset }
									...
									<ToggleControl
										...
										help={ _x(
											'Choose whether animation should fire once, or every time you scroll up/down to element.',
											'control help',
											'container-block'
										) }
										checked={ !! aosOnce }
									...
									'animate-right' !== imgEffect && (
										<Fragment>
											...
											<SelectControl
												...
												help={ _x(
													'This property sets if and how a background image will be repeated.',
													'control help',
													'container-block'
												) }
												value={ imgRepeat }
							...
							{ ( !! imgID || !! videoID ) &&
								backgroundColor.color && (
									<RangeControl
										...
										help={ _x(
											'This setting is useful if you are using a visually noisy background image or video and finding the content in your component difficult to read.',
											'control help',
											'container-block'
										) }
										readonly="readonly"
						...
						>
							<BaseControl>
								<p>
									{ _x(
										'I am a full-stack developer with over five years of experience in WordPress theme and plugin development, and would love to have the opportunity to discuss your project with you.',
										'upsell',
										'container-block'
									) }
								</p>
								<ExternalLink
									href={
										'https://www.upwork.com/o/profiles/users/_~016ad17ad3fc5cce94/'
									}
								>
									{ _x(
										'Hire Me!',
							...
							>
								<ExternalLink
									href={
										'https://wordpress.org/support/plugin/container-block/reviews'
									}
								>
									{ sprintf(
										_x(
											'Why not leave this plugin a %s review on WordPress.org!',
											'upsell',
											'container-block'
										),
										'⭐⭐⭐⭐⭐'
					...
					<InspectorAdvancedControls>
						<TextControl
							...
							help={ _x(
								'This attribute is used to define a string that labels the current element. You might use it in cases where a text label is not visible on the screen.',
								'control help',
								'container-block'
							) }
							value={ ariaLabel }
